...
! function (a, b, c, d) {
    ...
    var g = function(b, c) {
        return this.$element = a(b), this.elementId = b.id, this.styleId = this.elementId + "-style", this.init(c), {
            ...
            getTreeData: a.proxy(this.getTreeData, this),
    ...
    g.prototype.init = function(b) {
        ...
        if (b) {
            ...
            a.each(b, function(b, e) {
                for (var f = a(d.template.item).addClass("node-" + d.elementId).addClass((e.nodes && e.nodes.length) ? 'has-child' : 'no-child').addClass(e.state.checked ? "node-checked" : "").addClass(e.state.disabled ? "node-disabled" : "").addClass(e.state.selected ? "node-selected" : "").addClass(e.searchResult ? "search-result" : "").attr("data-nodeid", e.nodeId).attr("data-json", JSON.stringify(e)).attr("style", d.buildStyleOverride(e)), g = 0; c - 1 > g; g++) f.append(d.template.indent);
                var h = [];
            ...
            $('.treeview li.no-child').find(' > span.glyphicon-plus').removeClass('glyphicon-plus').addClass('glyphicon-minus'); //nhannguyen
        }
    ...
    }, g.prototype.getTreeData = function () {
        return this.tree;
    }, g.prototype.addNode = function (node) { //nhannguyen
        var selected = this.getSelected();
        selected = selected ? selected[0] : null;
        //if (selected)
        //    return false;
        var node = { "Id": "fd76dc8c-79b1-4975-8525-d63d761f5422", "IsRoot": false, "IsActive": true, "ParentId": "f80ed3a3-fd10-44c9-a804-c412617a6ed7", "Label": "Users2", "IsTitle": true, "IsLink": false, "ControllerName": "NULL", "ActionName": "NULL", "SectionParameter": 1, "Order": 7, "Level": 2, "text": "Users", "nodes": [{ "Id": "d49d0eb3-2e94-4482-a090-04821475e25f", "IsRoot": false, "IsActive": false, "ParentId": "fd76dc8c-79b1-4975-8525-d63d761f54ae", "Label": "Test4", "IsTitle": false, "IsLink": false, "ControllerName": "Account", "ActionName": "Test4", "SectionParameter": 0, "Order": 1, "Level": 3, "text": "Test4", "nodeId": 8, "parentId": 7, "selectable": true, "state": { "checked": false, "disabled": false, "expanded": false, "selected": false } }, { "Id": "0f943c4b-2d9f-4989-bc31-5624511e752d", "IsRoot": false, "IsActive": false, "ParentId": "fd76dc8c-79b1-4975-8525-d63d761f54ae", "Label": "Test5", "IsTitle": false, "IsLink": false, "ControllerName": "Account", "ActionName": "Test5", "SectionParameter": 0, "Order": 1, "Level": 3, "text": "Test5", "nodeId": 9, "parentId": 7, "selectable": true, "state": { "checked": false, "disabled": false, "expanded": false, "selected": false } }, { "Id": "0b25e286-b242-412a-a5d4-68edd5481927", "IsRoot": false, "IsActive": false, "ParentId": "fd76dc8c-79b1-4975-8525-d63d761f54ae", "Label": "Test2", "IsTitle": false, "IsLink": false, "ControllerName": "Account", "ActionName": "Test2", "SectionParameter": 0, "Order": 1, "Level": 3, "text": "Test2", "nodeId": 10, "parentId": 7, "selectable": true, "state": { "checked": false, "disabled": false, "expanded": false, "selected": false } }, { "Id": "24b3b7d0-a7d6-4610-85c4-9ad6bb6144a8", "IsRoot": false, "IsActive": false, "ParentId": "fd76dc8c-79b1-4975-8525-d63d761f54ae", "Label": "Test5", "IsTitle": false, "IsLink": false, "ControllerName": "Account", "ActionName": "Test5", "SectionParameter": 0, "Order": 1, "Level": 3, "text": "Test5", "nodeId": 11, "parentId": 7, "selectable": true, "state": { "checked": false, "disabled": false, "expanded": false, "selected": false } }, { "Id": "7716e11f-0edb-4113-844e-dcef88571a48", "IsRoot": false, "IsActive": false, "ParentId": "fd76dc8c-79b1-4975-8525-d63d761f54ae", "Label": "Test3", "IsTitle": false, "IsLink": false, "ControllerName": "Account", "ActionName": "Test3", "SectionParameter": 0, "Order": 1, "Level": 3, "text": "Test3", "nodeId": 12, "parentId": 7, "selectable": true, "state": { "checked": false, "disabled": false, "expanded": false, "selected": false } }, { "Id": "14d4ddf1-2a40-45b9-bd5d-e8cbdc566013", "IsRoot": false, "IsActive": true, "ParentId": "fd76dc8c-79b1-4975-8525-d63d761f54ae", "Label": "Password Rule", "IsTitle": false, "IsLink": true, "ControllerName": "User", "ActionName": "PasswordRule", "SectionParameter": 1, "Order": 8, "Level": 3, "text": "Password Rule", "nodeId": 13, "parentId": 7, "selectable": true, "state": { "checked": false, "disabled": false, "expanded": false, "selected": false } }, { "Id": "ae78a2e3-1d8d-4804-8294-efc3864525df", "IsRoot": false, "IsActive": false, "ParentId": "fd76dc8c-79b1-4975-8525-d63d761f54ae", "Label": "Test", "IsTitle": false, "IsLink": false, "ControllerName": "Account", "ActionName": "Test", "SectionParameter": 0, "Order": 1, "Level": 3, "text": "Test", "nodeId": 14, "parentId": 7, "selectable": true, "state": { "checked": false, "disabled": false, "expanded": false, "selected": false } }], "nodeId": 7, "parentId": 4, "selectable": true, "state": { "checked": false, "disabled": false, "expanded": true, "selected": true } };
        this.tree.push(node);
        this.expandNode(node, { ignoreChildren: false, silent: false });
